...
parser.add_argument("-m", "--method", dest='method', default='https', choices=['http', 'https'], help='By default SSL connectivity with the option of leveraging HTTP')
parser.add_argument("-e", "--enable", action='store', dest='enable', nargs='?', help='Use if passwordless enable is configured')
